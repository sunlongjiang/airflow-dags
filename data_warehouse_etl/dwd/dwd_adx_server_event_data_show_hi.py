...
if __name__ == "__main__":
    ...
    app_name = f"dwd_adx_server_event_data_show_hi_{date_str}_{hour_str}_{min_str}"
    spark = SparkSession.builder.appName(app_name).enableHiveSupport().getOrCreate()
    print(f"app_name = {app_name}")
    table = 'hungry_studio.dwd_adx_server_event_data_show_hi'
    # ##请求 MSCK REPAIR TABLE hungry_studio.dwd_adx_server_event_data_show_hi;
    # 定义分区字段的值
