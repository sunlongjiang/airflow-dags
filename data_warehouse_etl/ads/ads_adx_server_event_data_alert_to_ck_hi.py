...
if __name__ == "__main__":
    ...
    sync_sql = f"""
                SELECT 
                    ...
                    COALESCE(alert_name,"-") as alert_name,
                    COALESCE(trigger_type_id,"-") as trigger_type_id,
                    COALESCE(trigger_type_name,"-") as trigger_type_name,
                    COALESCE(trigger_metadata,"-") as trigger_metadata,
                    COALESCE(resp_json,"-") as resp_json,
